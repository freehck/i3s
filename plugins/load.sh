...
LOAD_MEDIUM_PERCENT=${LOAD_MEDIUM_PERCENT:-`i3s_load_func_percentize $LOAD_MEDIUM`}
LOAD_HIGH_PERCENT=${LOAD_HIGH_PERCENT:-`i3s_load_func_percentize $LOAD_HIGH`}
...
i3s_load() {
    ...
    la1p=`i3s_load_func_percentize $la1`
    la5p=`i3s_load_func_percentize $la5`
    la15p=`i3s_load_func_percentize $la15`
